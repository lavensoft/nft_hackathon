...
const anonymousActorActions = {
  CREATE_ANONYMOUS_ACTOR: {
    actions: xstate.forwardTo("anonymousActorService")
  },
...
const authStates = {
  ...
  states: {
    ...
    connected: {
      ...
      on: {
        CREATE_ACTOR: {
          actions: xstate.forwardTo("actorService")
        },
        DISCONNECT: {
    ...
    anonymousActorService: (context, _event) => (callback, onReceive) => {
      onReceive(async e => {
        if (e.type === "CREATE_ANONYMOUS_ACTOR") {
          ...
          const actor = agent.Actor.createActor(e.data.idlFactory, {
            agent: agent$1,
...
exports.connectMachine = rootMachine;
