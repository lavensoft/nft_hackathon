...
class AstroXConnector {
  ...
  async init() {
    classPrivateFieldGet._classPrivateFieldSet(this, _ic, await connection.IC.create({
      ...
      identityProvider: "".concat(classPrivateFieldGet._classPrivateFieldGet(this, _config).providerUrl, "/login#authorize"),
  ...
  async requestTransfer(_ref2) {
    ...
    return (_classPrivateFieldGet6 = classPrivateFieldGet._classPrivateFieldGet(this, _ic)) === null || _classPrivateFieldGet6 === void 0 ? void 0 : _classPrivateFieldGet6.requestTransfer({
