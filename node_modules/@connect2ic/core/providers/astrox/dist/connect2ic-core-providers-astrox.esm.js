...
class AstroXConnector {
  ...
  async init() {
    _classPrivateFieldSet(this, _ic, await IC.create({
      ...
      identityProvider: "".concat(_classPrivateFieldGet(this, _config).providerUrl, "/login#authorize"),
  ...
  async requestTransfer(_ref2) {
    ...
    return (_classPrivateFieldGet6 = _classPrivateFieldGet(this, _ic)) === null || _classPrivateFieldGet6 === void 0 ? void 0 : _classPrivateFieldGet6.requestTransfer({
